  ...
  return (
    <Paper as={Flex} items="center" gap="lg" className="section">
      ...
      <svg className="simple--develope" viewBox="0 0 490 491" width="300" fill="none">
        ...
        />
        <path fill="var(--bg-1)" fillRule="evenodd" d="M241 161c-1 31 2 63 0 94v-94Z" clipRule="evenodd" />
        <path
          stroke="var(--bg-9)"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        />
        <path fill="var(--bg-1)" fillRule="evenodd" d="M207 257c24-3 47-1 70-4l-70 4Z" clipRule="evenodd" />
        <path
          stroke="var(--bg-9)"
          strokeLinecap="round"
          strokeLinejoin="round"
