...
export const PaperBackground = () => {
  return (
    <>
      ...
      <Paper border width="30-char" ratio="1" background="su-5" />
      <Paper border width="30-char" ratio="1" background="su-8" />
      <Paper border width="30-char" ratio="1" background="su-11" />
      ...
      <Paper border width="30-char" ratio="1" background="su-3" />
      <Paper border width="30-char" ratio="1" background="su-8" />
      <Paper border width="30-char" ratio="1" background="su-12" />
