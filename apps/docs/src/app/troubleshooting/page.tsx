    ...
    <Paper flow="md" p="sm">
      ...
      <div className="l_f-sm">
        ...
        <Text>
          ...
          terminal as an administrator (for Windows).
        </Text>
      ...
      <div className="l_f-sm">
        ...
        <Text>
          ...
          place, usually at the entry point of your application (e.g., <code>App.js</code>). Check for any typos in the
          import statement.
        </Text>
        ...
        <Text>
          ...
          correctly, and there are no typos or syntax errors in your theme file.
        </Text>
      </div>
      ...
      <div className="l_f-sm">
        ...
        <Text>
          ...
          syntax and props as mentioned in the documentation.
        </Text>
      ...
      <div className="l_f-sm">
        ...
        <Text>
          ...
          <a href="https://github.com/HamzaAmar/pillar-ui/issues">GitHub Issues</a> to seek assistance from fellow users
          and our development team.
        </Text>

        <Text>
          Remember, troubleshooting can differ based on individual projects and setups. These are general instructions,
          so adapt them to suit your users needs and the specifics of your React application.
        </Text>
      </div>
    </Paper>
  )
...
export const metadata: Metadata = {
  ...
  description:
    'Encounter an issue with Pillar UI? Find solutions and guidance to common problems, and get back to smooth development.',
}
