...
```tsx
export { toSlug } from '@pillar/utils'
```
...
import { toSlug } from '@pillar/utils'
...
```tsx
export { toCapitalize } from '@pillar/utils'
```
...
```ts title='app.ts' showLineNumbers
import { toCapitalize } from '@pillar/utils'
...
```tsx
export { toKebabCase } from '@pillar/utils'
```
