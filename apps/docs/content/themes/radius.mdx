...
title: Radius
type: themes
excerpt: 'The following CSS variables define border radius for your project. These variables are responsive and adjust dynamically based on the viewport size. If you prefer different font sizes for your project, you can customize these values according to your needs.'
root: themes
