...
<Table>
  ...
  <TableRow>
    <TableColumn>`--font-1`</TableColumn>
  ...
  <TableRow>
    <TableColumn>`--font-2`</TableColumn>
  ...
  <TableRow>
    <TableColumn>`--font-3`</TableColumn>
...
- **Consider accessibility**: When using the --font-1 and --font-2 variables, exercise caution as smaller font sizes can potentially compromise accessibility. Ensure that the text remains legible and meets the minimum contrast requirements to accommodate users with visual impairments.
