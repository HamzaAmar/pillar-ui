...
import { Avatar } from '@pillar/core'
function(){
    return(
        <Avatar
            color="success"
...
function AlerCorners(){
    return(
        <Avatar varaint='solid' />
        <Avatar varaint='soft' />
        <Avatar varaint='outline' />
    )
}
...
function AlertAnimate(){
    return(
       ...
       <Avatar animate="jump" title="Success!" />
       <Avatar animate="zoom" title="Success!" />
    )
}
```
...
### (Variant , Color, Size , Corner) Props
...
function AlertGroupLimit() {
  return (
    <div>
      <Avatar.Group variant="outline" stack="stack">
        <Avatar animate="jump" title="Success!" />
        <Avatar animate="zoom" title="Success!" />
        <Avatar animate="zoom" title="Success!" />
      </Avatar.Group>
      <Avatar.Group size="lg" stack="grid">
        <Avatar animate="jump" title="Success!" />
        <Avatar animate="zoom" title="Success!" />
        <Avatar animate="zoom" title="Success!" />
      </Avatar.Group>
      <Avatar.Group corner="sharp" stack="grid">
        <Avatar animate="jump" title="Success!" />
        <Avatar animate="zoom" title="Success!" />
        <Avatar animate="zoom" title="Success!" />
      </Avatar.Group>
      <Avatar.Group color="danger" stack="grid">
        <Avatar animate="jump" title="Success!" />
        <Avatar animate="zoom" title="Success!" />
        <Avatar animate="zoom" title="Success!" />
      </Avatar.Group>
...
When using the Avatar component, it is important to add the title prop to the avatar images. This is because the title prop is used as an alternative text (alt text) that describes the content of the image. This is important for users who rely on screen readers to access the content on your website or application.

However, if the avatar is only for decoration or the information is redundant (i.e., the same information is already provided elsewhere on the section), then you can omit the title prop.

The Avatar component supports the prefers-reduced-motion media feature. This means that if a user has enabled the reduce motion preference in their browser, the animation of the avatar will be disabled. This is useful for users who have motion sensitivities or who prefer a more static user interface.
...
The Avatar component is fully typed with TypeScript, providing type definitions for all of its props.
