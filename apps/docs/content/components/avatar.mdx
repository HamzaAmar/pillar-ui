...
<Playground name="avatarIcon" root="avatar" />

### Size

The size prop determines the size of the Avatar. It accepts any of the Size types defined in your library, including (1, 2,3, sm, md, and lg, xl, 2xl, 3xl). If not provided, it defaults to the md size.
...
The corner prop determines the border radius of the Avatar. It accepts any of the Corner types defined in your library, including (square, 3, sm, md, xl, full, circle), and pill. If not provided, it defaults to the square corner.
