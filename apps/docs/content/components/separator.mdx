...
export const SeparatorTitle = () => {
  return (
    <Paper className="playground" as={Flex} gap="sm" borderColor="opacity-6" p="sm" background="bg-3" corner="sm">
...
export const SeparatorColors = () => {
  return (
    <Paper className="playground" borderColor="opacity-6" p="sm" flow="sm" background="bg-3" corner="sm">
