...
The corner prop is a prop that can be used to customize the corner radius of the InputFile component. Valid values for the corner prop are: `sharp` `3` `sm` `md` `lg` `xl` `full`
