...
The corner prop determines the border radius of the Badge. It accepts any of the Corner types defined in your library, including (square, 3, sm, md, xl, full, circle), and pill. If not provided, it defaults to the square corner.
