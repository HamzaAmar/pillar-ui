...
function PaperBackgrounds(){
    ...
    >
      ...
      <Paper borderColor="opacity-8" width="30-char" ratio="square" background="bg-1" />
      <Paper borderColor="opacity-8" width="30-char" ratio="square" background="bg-4" />
      <Paper borderColor="opacity-8" width="30-char" ratio="square" background="bg-8" />
