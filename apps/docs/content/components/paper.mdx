...
function PaperPadding() {
  return (
    ...
    >
      ...
      <Paper className="u_center" width="30-char" ratio="16-9" background="bg-5" m="sm">
        sm Margin
      </Paper>

      <Paper className="u_center" width="30-char" ratio="16-9" background="bg-5" m="xs">
        xs Margin
      </Paper>

      <Paper className="u_center" width="30-char" ratio="16-9" background="bg-5" m="2xs">
        2xs Margin
      </Paper>
    </Paper>
  )
...
function PaperMargin() {
  return (
    <Paper className="playground" borderColor="opa-6" p="sm" background="bg-3" corner="sm">
      <Paper className="u_center" width="30-char" ratio="16-9" background="bg-5" m="2xl">
        2xl Margin
      </Paper>
      <Paper className="u_center" width="30-char" ratio="16-9" background="bg-5" m="xl">
        xl Margin
      </Paper>
      <Paper className="u_center" width="30-char" ratio="16-9" background="bg-5" m="lg">
        lg Margin
      </Paper>

      <Paper className="u_center" width="30-char" ratio="16-9" background="bg-5" m="md">
        md Margin
      </Paper>
      <Paper className="u_center" width="30-char" ratio="16-9" background="bg-5" m="sm">
        sm Margin
