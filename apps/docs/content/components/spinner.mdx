...
title: Spinner
type: Components
excerpt: The Spinner component is used to indicate loading or progress state.
items: ['Spinner']
file: core
root: components
---
...
The color prop sets the color of the spinner. You can choose from a range of colors including green, red, orange, primary, purple, secondary, brown and surface.

<SpinnerPlayGround.Colors />
...
The Spinner component is implemented using React and TypeScript. It is part of the @pillar-ui/core package.
...
The Spinner component is fully typed and supports TypeScript.
