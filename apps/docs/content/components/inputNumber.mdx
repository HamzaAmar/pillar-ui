...
<InputNumberPlayGround.Bordered />
...
- Type: string
- Default: `primary`
- Options: `danger` | `warning` | `success` | `primary` | `secondary` | `surfacecece` | `primary` | `secondary`
