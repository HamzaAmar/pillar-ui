...
title: Grid
type: core
excerpt: The Grid component is a powerful layout tool that allows for the creation of responsive and complex layouts with ease. It facilitates the arrangement of components or elements into rows and columns, offering various customization options such as alignment, spacing, and placement.
items: ['Grid', 'GridItem']
