...
import { Accordion, AccordionItem } from '@pillar/core'
...
The Accordion component has full TypeScript support and includes type definitions for all props and callbacks.
