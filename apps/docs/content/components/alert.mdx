...
Type: string
Default: `primary`
Options: `red` | `danger` | `orange` | `warning` | `green` | `success` | `indigo` | `violet` | `purple` | `brown` | `slate` | `primary`
...
function AlertColors(){
    return(
        // danger or red
        <Alert title="Success!" color='red' />
        // warning or orange
        <Alert title="Success!" color='orange' />
        // success or green
        <Alert title="Success!" color='green' />
        <Alert title="Success!" color='indigo' />
        <Alert title="Success!" color='violet' />
        <Alert title="Success!" color='purple' />
        <Alert title="Success!" color='brown' />
        <Alert title="Success!" color='slate' />
    )
}
...
```tsx
<Alert as='span' color="danger" title="hello" style={{ background: 'green' }} />
<Alert as='article' color="danger" title="hello" style={{ background: 'green' }} />
```
