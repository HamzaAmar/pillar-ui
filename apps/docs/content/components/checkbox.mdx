  ...
  return (
    <div className="l_flow__md">
      <Flex items="center" gap="sm">
        <Checkbox size="3xs" variant="numeric" number={15} max={15} />
        <Checkbox size="2xs" variant="numeric" number={15} max={15} />
        <Checkbox size="xs" variant="numeric" number={15} max={15} />
        <Checkbox size="sm" variant="numeric" number={15} max={15} />
        <Checkbox size="md" variant="numeric" number={15} max={15} />
        <Checkbox size="lg" variant="numeric" number={15} max={15} />
        <Checkbox size="2xl" variant="numeric" number={15} max={15} />
        <Checkbox size="3xl" variant="numeric" number={15} max={15} />
      </Flex>
    </div>
  )
}
...
```tsx showLineNumbers title="Checkbox.tsx"
import { Flex, Checkbox } from '@pillar/core'
...
```tsx showLineNumbers title="Checkbox.tsx"
import { Checkbox } from '@pillar/core'
