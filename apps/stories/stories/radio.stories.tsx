  ...
  return (
    <div>
      <Flex gap="sm" items="center">
        ...
        <Radio color="b" name="bg" label="bg" />
  ...
  return (
    <div className="l_f-md">
      <Flex gap="sm" items="center">
        ...
        <Radio defaultChecked color="b" name="solid.bg" label="bg" />
      ...
      <Flex gap="sm" items="center">
        ...
        <Radio defaultChecked variant="outline" color="b" name="outline.bg" label="bg" />
      ...
      <Flex gap="sm" items="center">
        ...
        <Radio defaultChecked variant="soft" color="b" name="soft.bg" label="bg" />
  ...
  return (
    <div className="l_f-md">
      ...
      <Flex gap="sm" items="center">
        ...
        <Radio variant="outline" color="b" name="bg2" label="bg" />
      ...
      <Flex gap="sm" items="center">
        ...
        <Radio variant="soft" color="b" name="bg3" label="bg" />
...
export function RadioGroupVl() {
  return (
    <RadioGroup name="red" label="Choose you Color" showLabel size="lg" color="d">
      <Radio label="Nice" />
      <Radio label="To Meet" />
      <Radio label="Here IN " />
      <Radio label="Morocco" />
...
export function RadioGroupLongText() {
  return (
    <RadioGroup name="red" label="Choose you Color" showLabel size="md" color="d">
      <Radio
